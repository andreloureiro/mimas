(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("ReactMotion"), require("Measure"));
	else if(typeof define === 'function' && define.amd)
		define(["ReactMotion", "Measure"], factory);
	else if(typeof exports === 'object')
		exports["Transition"] = factory(require("ReactMotion"), require("Measure"));
	else
		root["Transition"] = factory(root["ReactMotion"], root["Measure"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	window.Transition = _Transition2['default'];
	    ...
	    this._getDefaultStyles = function () {
	      ...
	      return Children.map(children, function (child) {
	        return child && {
	          key: child.key,
	          data: child,
	          style: _extends({}, (0, _fromRMStyles2['default'])(childStyles))
	        };
	      });
	    };
	  ...
	  _createClass(Transition, [{
	    ...
	    value: function _childrenToRender(currValues) {
	      ...
	      return currValues.map(function (_ref3) {
	        ...
	        return createElement(_TransitionChild2['default'], {
	          key: key,
	          child: child,
	          style: style,
	    ...
	    key: 'propTypes',
	    value: {
	      component: PropTypes.oneOfType([PropTypes.string, PropTypes.bool, _isElement2['default']]),
	...
	var TransitionChild = (function (_Component) {
	  ...
	  _createClass(TransitionChild, [{
	    ...
	    value: function render() {
	      ...
	      return createElement(_reactMeasure2['default'], {
	        config: {
	          childList: true,
	          subtree: true
	        },
	        ...
	        onMeasure: onMeasure
	      }, cloneElement(child, { style: style, dimensions: dimensions }));
	    }
	  }]);
