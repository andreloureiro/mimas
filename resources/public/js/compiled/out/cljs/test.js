...
var args72606 = [];
var len__38501__auto___72610 = arguments.length;
var i__38502__auto___72611 = (0);
while(true){
if((i__38502__auto___72611 < len__38501__auto___72610)){
args72606.push((arguments[i__38502__auto___72611]));

var G__72612 = (i__38502__auto___72611 + (1));
i__38502__auto___72611 = G__72612;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args72606.length)].join('')));
...
var G__72609 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__72609,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__72609;
}
});
...
var or__37443__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__38501__auto___72617 = arguments.length;
var i__38502__auto___72618 = (0);
while(true){
if((i__38502__auto___72618 < len__38501__auto___72617)){
args__38508__auto__.push((arguments[i__38502__auto___72618]));

var G__72619 = (i__38502__auto___72618 + (1));
i__38502__auto___72618 = G__72619;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__38509__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq72614){
var G__72615 = cljs.core.first.call(null,seq72614);
var seq72614__$1 = cljs.core.next.call(null,seq72614);
var G__72616 = cljs.core.first.call(null,seq72614__$1);
var seq72614__$2 = cljs.core.next.call(null,seq72614__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__72615,G__72616,seq72614__$2);
});
...
var file = cljs.core.get.call(null,map__72623__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__72623__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__72623__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__72623,map__72623__$1,file,line,column){
return (function (p1__72620_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__72620_SHARP_));
});})(map__72623,map__72623__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__38356__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__38356__auto__,prefer_table__38357__auto__,method_cache__38358__auto__,cached_hierarchy__38359__auto__,hierarchy__38360__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__37443__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__37443__auto__)){
return or__37443__auto__;
} else {
...
var temp__4657__auto___72625 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___72625)){
var message_72626 = temp__4657__auto___72625;
cljs.core.println.call(null,message_72626);
} else {
}
...
var temp__4657__auto___72627 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___72627)){
var message_72628 = temp__4657__auto___72627;
cljs.core.println.call(null,message_72628);
} else {
}
...
var temp__4655__auto__ = (function (){var and__37431__auto__ = typeof exception.stack === 'string';
if(and__37431__auto__){
var G__72634 = exception.stack;
var G__72634__$1 = (((G__72634 == null))?null:clojure.string.split_lines.call(null,G__72634));
var G__72634__$2 = (((G__72634__$1 == null))?null:cljs.core.get.call(null,G__72634__$1,depth));
if((G__72634__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__72634__$2);
}
} else {
...
var vec__72635 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__72635,(0),null);
var column = cljs.core.nth.call(null,vec__72635,(1),null);
var vec__72636 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__72636,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__72636,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__72636,(2),null);
...
var m__$1 = (function (){var G__72638 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__72638) {
case "fail":
...
var G__72644 = (function (){var G__72643 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__72643);
} else {
return G__72643;
}
})();
...
return cljs.core.vary_meta.call(null,G__72646,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e72649){var e = e72649;
var G__72650 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__72650) {
...
var vec__72653 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__72653,(0),null);
var types = vec__72653;
...
return cljs.core.map.call(null,(function (p__72661){
var vec__72662 = p__72661;
var ns = cljs.core.nth.call(null,vec__72662,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__72662,(1),null);
return ((function (vec__72662,ns,vars__$1){
return (function (){
...
var G__72663 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__72663) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__72663,env,once_fixtures,each_fixtures,vec__72662,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__72663,env,once_fixtures,each_fixtures,vec__72662,ns,vars__$1){
return (function (){
var seq__72664 = cljs.core.seq.call(null,vars__$1);
var chunk__72665 = null;
var count__72666 = (0);
var i__72667 = (0);
while(true){
if((i__72667 < count__72666)){
var v = cljs.core._nth.call(null,chunk__72665,i__72667);
var temp__4657__auto___72669 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___72669)){
var t_72670 = temp__4657__auto___72669;
each_fixture_fn.call(null,((function (seq__72664,chunk__72665,count__72666,i__72667,t_72670,temp__4657__auto___72669,v,each_fixture_fn,G__72663,env,once_fixtures,each_fixtures,vec__72662,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_72670)));
});})(seq__72664,chunk__72665,count__72666,i__72667,t_72670,temp__4657__auto___72669,v,each_fixture_fn,G__72663,env,once_fixtures,each_fixtures,vec__72662,ns,vars__$1))
);
} else {
}

var G__72671 = seq__72664;
var G__72672 = chunk__72665;
var G__72673 = count__72666;
var G__72674 = (i__72667 + (1));
seq__72664 = G__72671;
chunk__72665 = G__72672;
count__72666 = G__72673;
i__72667 = G__72674;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__72664);
if(temp__4657__auto__){
var seq__72664__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__72664__$1)){
var c__38246__auto__ = cljs.core.chunk_first.call(null,seq__72664__$1);
var G__72675 = cljs.core.chunk_rest.call(null,seq__72664__$1);
var G__72676 = c__38246__auto__;
var G__72677 = cljs.core.count.call(null,c__38246__auto__);
var G__72678 = (0);
seq__72664 = G__72675;
chunk__72665 = G__72676;
count__72666 = G__72677;
i__72667 = G__72678;
continue;
} else {
var v = cljs.core.first.call(null,seq__72664__$1);
var temp__4657__auto___72679__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___72679__$1)){
var t_72680 = temp__4657__auto___72679__$1;
each_fixture_fn.call(null,((function (seq__72664,chunk__72665,count__72666,i__72667,t_72680,temp__4657__auto___72679__$1,v,seq__72664__$1,temp__4657__auto__,each_fixture_fn,G__72663,env,once_fixtures,each_fixtures,vec__72662,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_72680)));
});})(seq__72664,chunk__72665,count__72666,i__72667,t_72680,temp__4657__auto___72679__$1,v,seq__72664__$1,temp__4657__auto__,each_fixture_fn,G__72663,env,once_fixtures,each_fixtures,vec__72662,ns,vars__$1))
);
} else {
}

var G__72681 = cljs.core.next.call(null,seq__72664__$1);
var G__72682 = null;
var G__72683 = (0);
var G__72684 = (0);
seq__72664 = G__72681;
chunk__72665 = G__72682;
count__72666 = G__72683;
i__72667 = G__72684;
continue;
}
} else {
...
});})(each_fixture_fn,G__72663,env,once_fixtures,each_fixtures,vec__72662,ns,vars__$1))
);
});})(each_fixture_fn,G__72663,env,once_fixtures,each_fixtures,vec__72662,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1459021288135