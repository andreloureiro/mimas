...
return (function (){
var map__23528 = cljs.core.deref.call(null,route);
...
var page = cljs.core.get.call(null,map__23528__$1,new cljs.core.Keyword("active-route","page","active-route/page",513615823));
var params = cljs.core.get.call(null,map__23528__$1,new cljs.core.Keyword("active-route","params","active-route/params",778327881));
var pred__23530 = cljs.core._EQ_;
var expr__23531 = page;
if(cljs.core.truth_(pred__23530.call(null,new cljs.core.Keyword(null,"tasks","tasks",-1754368880),expr__23531))){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [mimas.views.tasks_view], null);
} else {
if(cljs.core.truth_(pred__23530.call(null,new cljs.core.Keyword(null,"task","task",-1476607993),expr__23531))){
...
if(cljs.core.truth_(pred__23530.call(null,new cljs.core.Keyword(null,"project","project",1124394579),expr__23531))){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [mimas.views.tasks_view], null);
} else {
...
//# sourceMappingURL=core.js.map?rel=1460522277867