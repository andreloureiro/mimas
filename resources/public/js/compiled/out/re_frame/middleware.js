...
while (G__43265__i < G__43265__a.length) {G__43265__a[G__43265__i] = arguments[G__43265__i + 0]; ++G__43265__i;}
  args = new cljs.core.IndexedSeq(G__43265__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__43266){
...
return (function (p1__43267_SHARP_){
return cljs.core.get_in.call(null,new_db,p1__43267_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__43268_SHARP_){
return cljs.core.get_in.call(null,db,p1__43268_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__43269__i = 0, G__43269__a = new Array(arguments.length -  2);
while (G__43269__i < G__43269__a.length) {G__43269__a[G__43269__i] = arguments[G__43269__i + 2]; ++G__43269__i;}
  in_paths = new cljs.core.IndexedSeq(G__43269__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__43270){
var f = cljs.core.first(arglist__43270);
arglist__43270 = cljs.core.next(arglist__43270);
var out_path = cljs.core.first(arglist__43270);
var in_paths = cljs.core.rest(arglist__43270);
...
//# sourceMappingURL=middleware.js.map?rel=1458659763987