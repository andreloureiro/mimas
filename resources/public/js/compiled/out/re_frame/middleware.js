...
while (G__43172__i < G__43172__a.length) {G__43172__a[G__43172__i] = arguments[G__43172__i + 0]; ++G__43172__i;}
  args = new cljs.core.IndexedSeq(G__43172__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__43173){
var args = cljs.core.seq(arglist__43173);
...
return cljs.core.get_in.call(null,new_db,p1__43174_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__43175_SHARP_){
return cljs.core.get_in.call(null,db,p1__43175_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__43176__i = 0, G__43176__a = new Array(arguments.length -  2);
while (G__43176__i < G__43176__a.length) {G__43176__a[G__43176__i] = arguments[G__43176__i + 2]; ++G__43176__i;}
  in_paths = new cljs.core.IndexedSeq(G__43176__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__43177){
var f = cljs.core.first(arglist__43177);
arglist__43177 = cljs.core.next(arglist__43177);
var out_path = cljs.core.first(arglist__43177);
var in_paths = cljs.core.rest(arglist__43177);
...
//# sourceMappingURL=middleware.js.map?rel=1456711304987