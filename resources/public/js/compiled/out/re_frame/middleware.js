...
while (G__50289__i < G__50289__a.length) {G__50289__a[G__50289__i] = arguments[G__50289__i + 0]; ++G__50289__i;}
  args = new cljs.core.IndexedSeq(G__50289__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__50290){
var args = cljs.core.seq(arglist__50290);
...
return cljs.core.get_in.call(null,new_db,p1__50291_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__50292_SHARP_){
return cljs.core.get_in.call(null,db,p1__50292_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__50293__i = 0, G__50293__a = new Array(arguments.length -  2);
while (G__50293__i < G__50293__a.length) {G__50293__a[G__50293__i] = arguments[G__50293__i + 2]; ++G__50293__i;}
  in_paths = new cljs.core.IndexedSeq(G__50293__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__50294){
var f = cljs.core.first(arglist__50294);
arglist__50294 = cljs.core.next(arglist__50294);
var out_path = cljs.core.first(arglist__50294);
var in_paths = cljs.core.rest(arglist__50294);
...
//# sourceMappingURL=middleware.js.map?rel=1456364838869