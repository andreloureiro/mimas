...
var args51617 = [];
var len__38501__auto___51621 = arguments.length;
var i__38502__auto___51622 = (0);
while(true){
if((i__38502__auto___51622 < len__38501__auto___51621)){
args51617.push((arguments[i__38502__auto___51622]));

var G__51623 = (i__38502__auto___51622 + (1));
i__38502__auto___51622 = G__51623;
continue;
} else {
}
break;
...
var G__51620 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__51620,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__51620;
}
});
...
var len__38501__auto___51628 = arguments.length;
var i__38502__auto___51629 = (0);
while(true){
if((i__38502__auto___51629 < len__38501__auto___51628)){
args__38508__auto__.push((arguments[i__38502__auto___51629]));

var G__51630 = (i__38502__auto___51629 + (1));
i__38502__auto___51629 = G__51630;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq51625){
var G__51626 = cljs.core.first.call(null,seq51625);
var seq51625__$1 = cljs.core.next.call(null,seq51625);
var G__51627 = cljs.core.first.call(null,seq51625__$1);
var seq51625__$2 = cljs.core.next.call(null,seq51625__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__51626,G__51627,seq51625__$2);
});
...
var file = cljs.core.get.call(null,map__51634__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__51634__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__51634__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__51634,map__51634__$1,file,line,column){
return (function (p1__51631_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__51631_SHARP_));
});})(map__51634,map__51634__$1,file,line,column))
...
var temp__4657__auto___51636 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___51636)){
var message_51637 = temp__4657__auto___51636;
cljs.core.println.call(null,message_51637);
} else {
}
...
var temp__4657__auto___51638 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___51638)){
var message_51639 = temp__4657__auto___51638;
cljs.core.println.call(null,message_51639);
} else {
}
...
var G__51645 = exception.stack;
var G__51645__$1 = (((G__51645 == null))?null:clojure.string.split_lines.call(null,G__51645));
var G__51645__$2 = (((G__51645__$1 == null))?null:cljs.core.get.call(null,G__51645__$1,depth));
if((G__51645__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__51645__$2);
}
} else {
...
var vec__51646 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__51646,(0),null);
var column = cljs.core.nth.call(null,vec__51646,(1),null);
var vec__51647 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__51647,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__51647,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__51647,(2),null);
...
var m__$1 = (function (){var G__51649 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__51649) {
case "fail":
...
var G__51655 = (function (){var G__51654 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__51654);
} else {
return G__51654;
}
})();
...
return cljs.core.vary_meta.call(null,G__51657,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e51660){var e = e51660;
var G__51661 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__51661) {
...
var vec__51664 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__51664,(0),null);
var types = vec__51664;
...
var ns = cljs.core.nth.call(null,vec__51673,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__51673,(1),null);
return ((function (vec__51673,ns,vars__$1){
return (function (){
...
var G__51674 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__51674) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__51674,env,once_fixtures,each_fixtures,vec__51673,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__51674,env,once_fixtures,each_fixtures,vec__51673,ns,vars__$1){
return (function (){
var seq__51675 = cljs.core.seq.call(null,vars__$1);
var chunk__51676 = null;
var count__51677 = (0);
var i__51678 = (0);
while(true){
if((i__51678 < count__51677)){
var v = cljs.core._nth.call(null,chunk__51676,i__51678);
var temp__4657__auto___51680 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___51680)){
var t_51681 = temp__4657__auto___51680;
each_fixture_fn.call(null,((function (seq__51675,chunk__51676,count__51677,i__51678,t_51681,temp__4657__auto___51680,v,each_fixture_fn,G__51674,env,once_fixtures,each_fixtures,vec__51673,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_51681)));
});})(seq__51675,chunk__51676,count__51677,i__51678,t_51681,temp__4657__auto___51680,v,each_fixture_fn,G__51674,env,once_fixtures,each_fixtures,vec__51673,ns,vars__$1))
);
} else {
}

var G__51682 = seq__51675;
var G__51683 = chunk__51676;
var G__51684 = count__51677;
var G__51685 = (i__51678 + (1));
seq__51675 = G__51682;
chunk__51676 = G__51683;
count__51677 = G__51684;
i__51678 = G__51685;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__51675);
if(temp__4657__auto__){
var seq__51675__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__51675__$1)){
var c__38246__auto__ = cljs.core.chunk_first.call(null,seq__51675__$1);
var G__51686 = cljs.core.chunk_rest.call(null,seq__51675__$1);
var G__51687 = c__38246__auto__;
var G__51688 = cljs.core.count.call(null,c__38246__auto__);
var G__51689 = (0);
seq__51675 = G__51686;
chunk__51676 = G__51687;
count__51677 = G__51688;
i__51678 = G__51689;
continue;
} else {
var v = cljs.core.first.call(null,seq__51675__$1);
var temp__4657__auto___51690__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___51690__$1)){
var t_51691 = temp__4657__auto___51690__$1;
each_fixture_fn.call(null,((function (seq__51675,chunk__51676,count__51677,i__51678,t_51691,temp__4657__auto___51690__$1,v,seq__51675__$1,temp__4657__auto__,each_fixture_fn,G__51674,env,once_fixtures,each_fixtures,vec__51673,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_51691)));
});})(seq__51675,chunk__51676,count__51677,i__51678,t_51691,temp__4657__auto___51690__$1,v,seq__51675__$1,temp__4657__auto__,each_fixture_fn,G__51674,env,once_fixtures,each_fixtures,vec__51673,ns,vars__$1))
);
} else {
}

var G__51692 = cljs.core.next.call(null,seq__51675__$1);
var G__51693 = null;
var G__51694 = (0);
var G__51695 = (0);
seq__51675 = G__51692;
chunk__51676 = G__51693;
count__51677 = G__51694;
i__51678 = G__51695;
continue;
}
} else {
...
});})(each_fixture_fn,G__51674,env,once_fixtures,each_fixtures,vec__51673,ns,vars__$1))
);
});})(each_fixture_fn,G__51674,env,once_fixtures,each_fixtures,vec__51673,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1459008358727