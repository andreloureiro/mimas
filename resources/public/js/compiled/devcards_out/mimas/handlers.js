...
mimas.handlers.form_update_value = (function mimas$handlers$form_update_value(db,p__78108){
var vec__78110 = p__78108;
var _ = cljs.core.nth.call(null,vec__78110,(0),null);
var k = cljs.core.nth.call(null,vec__78110,(1),null);
var v = cljs.core.nth.call(null,vec__78110,(2),null);
...
var map__78113 = new cljs.core.Keyword("task","form","task/form",-1627647084).cljs$core$IFn$_invoke$arity$1(db);
var map__78113__$1 = ((((!((map__78113 == null)))?((((map__78113.cljs$lang$protocol_mask$partition0$ & (64))) || (map__78113.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__78113):map__78113);
var title = cljs.core.get.call(null,map__78113__$1,new cljs.core.Keyword("form","title","form/title",629162795));
var project = cljs.core.get.call(null,map__78113__$1,new cljs.core.Keyword("form","project","form/project",1114967447));
...
mimas.handlers.task_edit = (function mimas$handlers$task_edit(db,p__78115){
var vec__78117 = p__78115;
var _ = cljs.core.nth.call(null,vec__78117,(0),null);
var task = cljs.core.nth.call(null,vec__78117,(1),null);
...
var map__78120 = db;
var map__78120__$1 = ((((!((map__78120 == null)))?((((map__78120.cljs$lang$protocol_mask$partition0$ & (64))) || (map__78120.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__78120):map__78120);
var editing = cljs.core.get.call(null,map__78120__$1,new cljs.core.Keyword("task","editing","task/editing",1370614286));
...
mimas.handlers.task_remove = (function mimas$handlers$task_remove(db,p__78123){
var vec__78125 = p__78123;
var _ = cljs.core.nth.call(null,vec__78125,(0),null);
var id = cljs.core.nth.call(null,vec__78125,(1),null);
var new_list = cljs.core.remove.call(null,((function (vec__78125,_,id){
return (function (p1__78122_SHARP_){
return cljs.core._EQ_.call(null,id,new cljs.core.Keyword("task","id","task/id",-1375673137).cljs$core$IFn$_invoke$arity$1(p1__78122_SHARP_));
});})(vec__78125,_,id))
...
mimas.handlers.toggle_done = (function mimas$handlers$toggle_done(db,p__78127){
var vec__78129 = p__78127;
var _ = cljs.core.nth.call(null,vec__78129,(0),null);
var task = cljs.core.nth.call(null,vec__78129,(1),null);
var new_task_list = cljs.core.mapv.call(null,((function (vec__78129,_,task){
return (function (p1__78126_SHARP_){
return mimas.handlers.toggle_task_done.call(null,p1__78126_SHARP_,task);
});})(vec__78129,_,task))
,new cljs.core.Keyword("task","list","task/list",761502432).cljs$core$IFn$_invoke$arity$1(db));
...
//# sourceMappingURL=handlers.js.map?rel=1456512410296