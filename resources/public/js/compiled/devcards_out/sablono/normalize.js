...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__43224_SHARP_){
return ((p1__43224_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__43224_SHARP_ === 'string');
}),class$__$1))){
...
var G__43226 = attrs;
var G__43226__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(attrs))?cljs.core.update_in.call(null,G__43226,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$):G__43226);
return G__43226__$1;
});
/**
...
var len__36572__auto___43230 = arguments.length;
var i__36573__auto___43231 = (0);
while(true){
if((i__36573__auto___43231 < len__36572__auto___43230)){
args__36579__auto__.push((arguments[i__36573__auto___43231]));

var G__43232 = (i__36573__auto___43231 + (1));
i__36573__auto___43231 = G__43232;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__36580__auto__);
});
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,p1__43227_SHARP_);
});})(maps__$1))
...
var G__43229 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
var G__43229__$1 = ((!(cljs.core.empty_QMARK_.call(null,classes__$1)))?cljs.core.assoc.call(null,G__43229,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1):G__43229);
return G__43229__$1;
});

sablono.normalize.merge_with_class.cljs$lang$maxFixedArity = (0);

sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq43228){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq43228));
});
/**
...
var vec__43236 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__43236,(0),null);
var names = cljs.core.nth.call(null,vec__43236,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__43236,tag_name,names){
return (function (p1__43233_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__43233_SHARP_));
});})(matches,vec__43236,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__43236,tag_name,names){
return (function (p1__43234_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__43234_SHARP_));
});})(matches,vec__43236,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__43237){
var vec__43240 = p__43237;
var tag = cljs.core.nth.call(null,vec__43240,(0),null);
var content = cljs.core.nthnext.call(null,vec__43240,(1));
...
var vec__43241 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__43241,(0),null);
var id = cljs.core.nth.call(null,vec__43241,(1),null);
var class$ = cljs.core.nth.call(null,vec__43241,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1456361404005