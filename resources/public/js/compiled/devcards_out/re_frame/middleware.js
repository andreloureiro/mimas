...
var G__49079__i = 0, G__49079__a = new Array(arguments.length -  0);
while (G__49079__i < G__49079__a.length) {G__49079__a[G__49079__i] = arguments[G__49079__i + 0]; ++G__49079__i;}
  args = new cljs.core.IndexedSeq(G__49079__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__49080){
var args = cljs.core.seq(arglist__49080);
...
return cljs.core.get_in.call(null,new_db,p1__49081_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__49082_SHARP_){
return cljs.core.get_in.call(null,db,p1__49082_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__49083__i = 0, G__49083__a = new Array(arguments.length -  2);
while (G__49083__i < G__49083__a.length) {G__49083__a[G__49083__i] = arguments[G__49083__i + 2]; ++G__49083__i;}
  in_paths = new cljs.core.IndexedSeq(G__49083__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__49084){
var f = cljs.core.first(arglist__49084);
arglist__49084 = cljs.core.next(arglist__49084);
var out_path = cljs.core.first(arglist__49084);
var in_paths = cljs.core.rest(arglist__49084);
...
//# sourceMappingURL=middleware.js.map?rel=1456363426465