...
var G__43162 = o;
(G__43162[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__43164__i < G__43164__a.length) {G__43164__a[G__43164__i] = arguments[G__43164__i + 0]; ++G__43164__i;}
  args = new cljs.core.IndexedSeq(G__43164__a,0);
} 
...
var args = cljs.core.seq(arglist__43165);
...
var G__43170 = jsprops;
(G__43170["defaultValue"] = value);

(G__43170["onChange"] = ((function (G__43170,v,value,on_change){
return (function (p1__43168_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__43168_SHARP_);
});})(G__43170,v,value,on_change))
);
...
var vec__43175 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__43175,(0),null);
var id = cljs.core.nth.call(null,vec__43175,(1),null);
var class$ = cljs.core.nth.call(null,vec__43175,(2),null);
...
var jsprops = {"argv": v};
var temp__4429__auto___43178 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4429__auto___43178 == null)){
} else {
var key_43179 = temp__4429__auto___43178;
(jsprops["key"] = key_43179);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__43181 = (new reagent.impl.template.NativeWrapper());
(G__43181["name"] = c);
...
var len__36572__auto___43187 = arguments.length;
var i__36573__auto___43188 = (0);
while(true){
if((i__36573__auto___43188 < len__36572__auto___43187)){
args__36579__auto__.push((arguments[i__36573__auto___43188]));

var G__43189 = (i__36573__auto___43188 + (1));
i__36573__auto___43188 = G__43189;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq43185){
var G__43186 = cljs.core.first.call(null,seq43185);
var seq43185__$1 = cljs.core.next.call(null,seq43185);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__43186,seq43185__$1);
});
...
break;
default:
var G__43193 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__43193;
continue;
...
var n__36417__auto___43194 = a.length;
var i_43195 = (0);
while(true){
if((i_43195 < n__36417__auto___43194)){
(a[i_43195] = reagent.impl.template.as_element.call(null,(a[i_43195])));

var G__43196 = (i_43195 + (1));
i_43195 = G__43196;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__36417__auto___43197 = a.length;
var i_43198 = (0);
while(true){
if((i_43198 < n__36417__auto___43197)){
var val_43199 = (a[i_43198]);
if((cljs.core.vector_QMARK_.call(null,val_43199)) && ((reagent.impl.template.key_from_vec.call(null,val_43199) == null))){
(o["no-key"] = true);
} else {
}

(a[i_43198] = reagent.impl.template.as_element.call(null,val_43199));

var G__43200 = (i_43198 + (1));
i_43198 = G__43200;
continue;
} else {
}
...
var ctx = {};
var vec__43202 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__43202,(0),null);
var derefed = cljs.core.nth.call(null,vec__43202,(1),null);
...
var G__43204 = (cljs.core.count.call(null,argv) - first_child);
switch (G__43204) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__43204){
...
//# sourceMappingURL=template.js.map?rel=1456361403831