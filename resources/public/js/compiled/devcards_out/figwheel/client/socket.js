...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__45630){
var map__45633 = p__45630;
var map__45633__$1 = ((((!((map__45633 == null)))?((((map__45633.cljs$lang$protocol_mask$partition0$ & (64))) || (map__45633.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45633):map__45633);
var opts = map__45633__$1;
var retry_count = cljs.core.get.call(null,map__45633__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
var retried_count = cljs.core.get.call(null,map__45633__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var websocket_url = cljs.core.get.call(null,map__45633__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var build_id = cljs.core.get.call(null,map__45633__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
...
socket.onmessage = ((function (url,socket,WebSocket,temp__4423__auto__,map__45633,map__45633__$1,opts,retry_count,retried_count,websocket_url,build_id){
...
});})(url,socket,WebSocket,temp__4423__auto__,map__45633,map__45633__$1,opts,retry_count,retried_count,websocket_url,build_id))
;

socket.onopen = ((function (url,socket,WebSocket,temp__4423__auto__,map__45633,map__45633__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__4423__auto__,map__45633,map__45633__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__4423__auto__,map__45633,map__45633__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__4423__auto__,map__45633,map__45633__$1,opts,retry_count,retried_count,websocket_url,build_id))
...
socket.onerror = ((function (url,socket,WebSocket,temp__4423__auto__,map__45633,map__45633__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1456361407413